...
echo ""
echo "  Insurance Demo    http://localhost:3020"
echo "  Insurance Setup   http://localhost:3020/setup/"
echo ""
...
echo "  For the insurance demo, open Insurance Setup to register consent elements."
echo "════════════════════════════════════════════════════════════"
echo ""
